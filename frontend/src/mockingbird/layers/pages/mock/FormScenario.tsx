...
export default function FormScenario(props: Props) {
  ...
  const onGetValues = useCallback(() => {
    return mapFormDataToScenario(watch(), callbacks, serviceId);
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <FormFieldset legend="Источник">
        <FormRow {...extractError('source', errors)}>
          <Sources
            name="source"
        ...
        <FormRow {...extractError('input', errors)}>
          <Textarea
            name="input"
            label="Запрос"
      ...
      <FormFieldset legend="Получатель">
