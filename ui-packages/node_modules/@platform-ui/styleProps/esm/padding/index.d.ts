...
export declare const pickPaddingProps: import("../types").PropsPicker<PaddingProps>;
export declare const calcPaddingStyle: (props: PaddingProps) => CSSProperties;
export declare const usePaddingStyle: (props: PaddingProps) => CSSProperties;
export declare const usePaddingProps: <TProps extends PaddingProps & import("../types").PropsWithStyle>(props: TProps) => Omit<TProps, keyof PaddingProps> & {
    style: {
