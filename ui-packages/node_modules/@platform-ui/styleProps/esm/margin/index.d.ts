...
export declare const pickMarginProps: import("../types").PropsPicker<MarginProps>;
export declare const calcMarginStyle: (props: MarginProps) => CSSProperties;
export declare const useMarginStyle: (props: MarginProps) => CSSProperties;
export declare const useMarginProps: <TProps extends MarginProps & import("../types").PropsWithStyle>(props: TProps) => Omit<TProps, keyof MarginProps> & {
    style: {
