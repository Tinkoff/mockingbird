...
export declare const pickFlexItemProps: import("../types").PropsPicker<FlexItemProps>;
export declare const calcFlexItemStyle: (props: FlexItemProps) => FlexItemProps;
export declare const useFlexItemStyle: (props: FlexItemProps) => FlexItemProps;
export declare const useFlexItemProps: <TProps extends FlexItemProps & import("../types").PropsWithStyle>(props: TProps) => Omit<TProps, keyof FlexItemProps> & {
    style: {
