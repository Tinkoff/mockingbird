import type { PropsWithStyle, PropsPicker, StyleHook } from '../types';
export declare const createPropsHook: <TStyleProps extends {}>(pickStyleProps: PropsPicker<TStyleProps>, useStyle: StyleHook<TStyleProps>) => <TProps extends TStyleProps & PropsWithStyle>(props: TProps) => Omit<TProps, keyof TStyleProps> & {
    style: {
