...
export interface ButtonProps extends Omit<ClickableProps, 'unselectable' | 'innerClassName' | 'className'> {
    /**
     * Атрибут aria-busy
     */
    ariaBusy?: boolean;
     ...
     * Цветовая схема
     */
    theme?: CustomTheme | 'primary' | 'secondary' | 'secondaryLight' | 'outline' | 'outlineDark' | 'outlineLight' | 'flat' | 'flatDark' | 'flatLight' | 'mono';
    /**
     * Размер
     */
    size?: 'xl' | 'l' | 'm' | 's' | 'xs';
    ...
    /**
     *  Отключает вертикальный padding
     */
