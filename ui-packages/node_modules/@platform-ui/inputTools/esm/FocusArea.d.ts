...
export interface FocusAreaProps extends React.HTMLAttributes<HTMLElement> {
    /**
     * HTML тег компонента
     */
    tagName?: keyof React.ReactHTML;
}
declare const FocusArea: ({ tagName, onMouseDown, ...props }: FocusAreaProps) => React.DetailedReactHTMLElement<{
