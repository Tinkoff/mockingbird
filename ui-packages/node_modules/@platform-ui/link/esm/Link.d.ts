...
export interface LinkProps extends DataQaInterface, Omit<ClickableProps, 'className' | 'innerClassName' | 'style'> {
    /**
     * Включает стиль «псевдо-ссылки»
     */
    pseudo?: boolean;
    /**
     * Атрибут href у ссылки
     */
    href?: string;
    /**
     * Тема компонента
     */
    theme?: CustomTheme | 'default' | 'light' | 'dark' | 'custom';
}
