...
const _excluded = ["direction", "childrenRect", "popoverRect", "windowMargin", "containerScroll", "additionalShift", "customPadding", "minArrowOffset", "align", "containerOffsets"];
...
const setHorizontal = _ref => {
  let {
    ...
    containerOffsets
      ...
      otherArgs = _objectWithoutPropertiesLoose(_ref, _excluded);
...
export function setPositionAuto(args) {
