...
export declare const CheckboxLabeled: import("react").ForwardRefExoticComponent<Omit<Omit<import("@platform-ui/checkbox").CheckboxStatelessProps, keyof import("./withLabel").LabeledInputProps> & Omit<import("./Label").LabelProps, "input"> & {
    hintBlock?: import("react").ReactNode;
}, keyof import("@platform-ui/stateUtils").CheckableInputPropsConstraint<any, import("@platform-ui/stateUtils").ChangeParams, any, import("@platform-ui/stateUtils").ChangeParams, any, import("@platform-ui/stateUtils").ChangeParams>> & Partial<Pick<Omit<import("@platform-ui/checkbox").CheckboxStatelessProps, keyof import("./withLabel").LabeledInputProps> & Omit<import("./Label").LabelProps, "input"> & {
    hintBlock?: import("react").ReactNode;
