...
function arity2(b, a) {
  return function () {
    return a.apply(void 0, arguments).then(b);
  };
}

function arity3(c, b, a) {
  return function () {
    return a.apply(void 0, arguments).then(b).then(c);
  };
}
...
function arity4(d, c, b, a) {
  ...
  return function () {
    return a.apply(void 0, arguments).then(b).then(c).then(d);
  };
}
/**
...
function composeP() {
  ...
  switch (chain.length) {
    ...
    default:
      return composeP(composeP.apply(void 0, chain.slice(0, 4)), composeP.apply(void 0, chain.slice(4)));
  }
}
